...
<div class="mycontainer">
  ...
  <div class="text-block">
    ...
    <h2 style="color: white; font-size: 30px;font-weight: 700;">Golf Tours and Packages / Details {{ isset($tour->country->country_name) ? $tour->country->country_name: ''}}</h2>
    ...
    <div class="container" style="margin-top: 100px;"><br>
    	...
    	<header class="section-header">
          ...
          <h5 class="section-title">
            ...
            <span class="fa fa-map-pin" style="color: #f2892d; font-size: 27px; padding: 13px 12px;">

            </span> {{ isset($tour->country->country_name) ? $tour->country->country_name: ''}} <i class="fa fa-angle-double-right"></i> {{isset($tour->province->province_name) ? $tour->province->province_name: ''}} <i class="fa fa-angle-double-right"></i> {{ isset($tour->title)? $tour->title:'' }}

             <span style="color:green;">{{isset($tour->tour_price) ? $tour->tour_price.'USD': ''}} <small style="font-size: 0.5em;">
