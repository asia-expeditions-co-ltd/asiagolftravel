						      	...
						      	<div class="col-md-12 col-md-12">
			                        ...
			                        <div class="form-group row">
			                        	...
			                        	<div class="col-md-4">
				                        	...
				                        	<label for="province">Supplier</label>

				                        	<select name="supplier" class="form-control " id="province">

												<option value="">--select--</option>

												@foreach(\App\Supplier::where(['country_id'=>$tour->country_id])->orderBy('supplier_name', 'ASC')->get() as $sup)

											<option value="{{$sup->id}}" {{$tour->supplier_id == $sup->id ? 'selected': ''}}> {{$sup->supplier_name}}
			                        ...
			                        <div class="form-group row">
			                        	...
			                        	<div class="col-md-6">
					                        ...
					                        <select class="form-control" name="tourtype">
					                        	...
					                        	<option value="2" {{$tour->type == 2 ? 'selected':''}}>Golf Courses</option>

					                        	<option value="3" {{$tour->type == 3 ? 'selected':''}}>Hotels and Resorts</option>
