        ...
        try{
            ...
            if($req->hasFile('gallery')){
                ...
                foreach ($req->gallery as $key => $tmpGallary) {
                    ...
                    $imgb->save(public_path('photos/share/'.$gallery));
            ...
            if ( $req->hasFile('image') ) {
                ...
                $imgbig->save(public_path('photos/share/'.$photo));
        ...
        try{
            ...
            if($req->hasFile('gallery')){
                ...
                foreach ($req->gallery as $key => $tmpGallary) {
                    ...
                    $gallery = time().'-'.$tmpGallary->getClientOriginalName();
                    $imgbig = Image::make($tmpGallary->getRealPath())->fit(1024, 768);
                    ...
                    $imgbig->save(public_path('photos/share/'.$gallery));
